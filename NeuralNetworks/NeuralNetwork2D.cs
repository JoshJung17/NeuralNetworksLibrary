...
{
    /// <summary>
    /// Represents a neural network that uses one or more channels of 2-dimensional input
    /// </summary>
    public class NeuralNetwork2D
    {
        /// <summary>
        /// Represents the identity activation function: A(x)=x
        /// </summary>
        public const int ACTIVATION_IDENTITY = 0;
        /// <summary>
        /// Represents the hyperbolic tangent activation function: A(x)=Tanh(x)
        /// </summary>
        public const int ACTIVATION_TANH = 1;
        /// <summary>
        /// Represents the rectified linear activation function: A(x)=max(x,0)
        /// </summary>
        public const int ACTIVATION_RELU = 2;

        private InputLayer2D _head;
        private List<Layer> _layers;
        internal static Random Rand = new Random();
        private int _iterations;

        /// <summary>
        /// Initializes an instance of a neural network given an input layer
        /// </summary>
        /// <param name="head">A 2-dimensional input layer</param>
        public NeuralNetwork2D(InputLayer2D head)
        {
            _head = head;
